    ...
    <div id="content" class="wrap">
        <div class="wrap clearfix">
            ...
            <div class="copy-form-wrapper grid_section">
                <div class="section_inner">
                    <div class="list-wrap">
                        <h1 class="page-title <?php if($class) {echo $class; } ?>"><?php the_title(); ?></h1>
                        <?php the_content(); ?>
                    </div>
        ...
        <div class="form-wrapper grid_section">
            <div class="section_inner">
                <div class="form-copy">
                    ...
                    <hr>
                    <p>Our camp consultants are available to answer all of your questions</p>
                </div>
                <div class="form-container">
                    <?php
