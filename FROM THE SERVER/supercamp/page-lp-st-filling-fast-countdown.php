<?php
/*
 * Template Name: LP - #1 Teen Camp - Stanford Filling
 */
        ...
        <div class="wrap clearfix">
            ...
            <div class="copy-form-wrapper grid_section">
                <div class="section_inner">
                    <div class="list-wrap">
<div>
<h1 style="color: white; font-weight: bold; text-align: center; padding:8px;">Attention: Our first four Stanford sessions are already full. Call (800) 228-5327 now to reserve your space at the last available session.</h1>
</div>
                        <?php the_content(); ?>
                    </div>
                    <div class="form-copy-wrapper">
						...
						<div style="padding-top: 40px; position: absolute; width: 100%; text-align: center;">
					<?php
			echo do_shortcode('[waiting name="Camp"]'); 
			 ?><div style="font-size:24px;font-weight:bold;color:white;">Until camp</div>
					</div>
                    </div>
